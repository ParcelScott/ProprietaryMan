    ...
    <div className="bg-background text-text font-body">
      ...
      >
        ...
        <div className="relative z-10 text-center p-4 pb-16 sm:p-8 sm:pb-24">
          <h1 className="text-2xl sm:text-5xl lg:text-6xl font-heading font-bold text-white tracking-normal sm:tracking-wider uppercase">
            The Data Scientist & The Standard Deviations
          </h1>
          <h2 className="text-base md:text-2xl font-heading text-white mt-4" style={{ textShadow: '0 2px 4px rgba(0, 0, 0, 0.5)' }}>
